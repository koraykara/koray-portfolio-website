...
const experiences: Experience[] = [
  {
    ...
    year: 2021,
    description: [
      "Designed and developed flight control software for real-time, safety-critical aerospace systems used in advanced training  platforms.",
      "Improved automation and data acquisition workflows by implementing custom C++ libraries for embedded computing environments.",
      "Led the development of desktop applications using C++ and the Qt framework.",
      "Actively contributed to DO-178C compliance processes and utilized real-time operating systems such as Green Hills INTEGRITY for high-assurance software components.",
    ],
    technologies: [
      "C++",
      "Qt",
